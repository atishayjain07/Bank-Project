...
heading=new Label("\t\t\t\t\tWithdraw Money");
...
withdrawb=new Button("Withdraw Amount");
sourcec=new Choice();
...
withdrawb.setForeground(Color.green);
...
withdrawb.setBounds(640,510,180,40);
